// backend/server.js - Updated with Poetry System
...
const proposalState = {
    ...
    timestamp: null,
    ipAddress: null,
    loveMeter: null // Random romantic score
};
...
// Romantic compliments generator
const COMPLIMENTS = {
    YES: [
...
// 🎵 Custom romantic notification sound URLs (optional)
const SOUNDS = {
...
app.post('/api/respond', (req, res) => {
    ...
    // Get random poem and compliment
...
// 🎨 Get a random love quote (for display)
